  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="150px">
      ...
      <el-form-item label="Built-in" prop="configType">
        <el-select v-model="queryParams.configType" placeholder="Built-in" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Number" align="center" prop="configId" />
      ...
      <el-table-column label="Key Value" align="center" prop="configValue" :show-overflow-tooltip="true" />
      <el-table-column label="Built-in" align="center" prop="configType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_yes_no" :value="scope.row.configType"/>
        </template>
      </el-table-column>
      <el-table-column label="Description" align="center" prop="remark" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        <el-form-item label="Parameter Name" prop="configName">
          <el-input v-model="form.configName" placeholder="Enter parameter name" />
        </el-form-item>
        ...
        <el-form-item label="Value" prop="configValue">
          <el-input v-model="form.configValue" placeholder="Enter parameter value" />
        </el-form-item>
        <el-form-item label="Built-in" prop="configType">
        ...
        <el-form-item label="Description" prop="remark">
          <el-input v-model="form.remark" type="textarea" placeholder="Enter description" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        configName: [
          { required: true, message: "Parameter name can't be blank", trigger: "blur" }
        ],
        configKey: [
          { required: true, message: "Parameter key can't be blank", trigger: "blur" }
        ],
        configValue: [
          { required: true, message: "Parameter value can't be blank", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleRefreshCache() {
      refreshCache().then(() => {
        this.$modal.msgSuccess("successfully flushed");
      });
    }
  }
};
