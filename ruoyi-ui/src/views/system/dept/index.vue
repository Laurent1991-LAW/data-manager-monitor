<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Creation Date" align="center" prop="createTime" width="200">
        <template slot-scope="scope">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="E-mail" prop="email">
              <el-input v-model="form.email" placeholder="Please enter e-mail" maxlength="50" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        parentId: [
          { required: true, message: "Superior department can't be blank", trigger: "blur" }
        ],
        deptName: [
          { required: true, message: " department name  can't be blank", trigger: "blur" }
        ],
        orderNum: [
        ...
        email: [
          {
            type: "email",
            message: "Please enter formatted e-mail address",
            trigger: ["blur", "change"]
          }
        ],
        phone: [
          {
            ...
            message: "Please enter formatted phone number",
            trigger: "blur"
          }
        ]
      }
